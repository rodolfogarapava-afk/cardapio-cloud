    ...
    extend: {
      ...
      colors: {
        ...
        vendor: {
          ...
          border: "hsl(var(--vendor-border))",
        },
        hub: {
          food: "hsl(var(--hub-food))",
          market: "hsl(var(--hub-market))",
          services: "hsl(var(--hub-services))",
          wellness: "hsl(var(--hub-wellness))",
          beauty: "hsl(var(--hub-beauty))",
          all: "hsl(var(--hub-all))",
